...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'APP': {
            'client_id': os.environ.get('GOOGLE_CLIENT_ID', 'temporary-dummy-value'),
            'secret': os.environ.get('GOOGLE_CLIENT_SECRET', 'temporary-dummy-value'),
            'key': ''
        }
    },
    'github': {
        'APP': {
            'client_id': 'Ov23lihMYebpE2WqupoF',
            'secret': 'e7658456713ef554d134af293bf58514f210ec8f',
            'key': ''
        }
    }
}
